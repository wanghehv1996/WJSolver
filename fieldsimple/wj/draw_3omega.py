...
res = 64*64
mat1 = numpy.fromfile('./wjacobi_data_0010_1.dat', dtype = numpy.float64)
mat1 = mat1.reshape((-1, res*3+1))

mat2 = numpy.fromfile('./wjacobi_data_0010_2div3.dat', dtype = numpy.float64)
